...
function Card({ profileImg, userName, location, postImg, likes, userComment, comments, postTime, dislikes, commentCount }) {
  return (
    <div className="card">
      <div className="top">
